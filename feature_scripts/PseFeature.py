...
def Pse_feature(fastas):
    ...
    sequence_read_save.save_to_csv(encodings,"./features/PseKNC.csv")
    ...
    sequence_read_save.save_to_csv(encodings,"./features/SCPseDNC.csv")
    ...
    sequence_read_save.save_to_csv(encodings,"./features/SCPseTNC.csv")
